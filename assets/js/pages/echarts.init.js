...
(option = {
	...
	xAxis: {
		axisLine: { lineStyle: { color: "#858d98" } },
		splitLine: {
			lineStyle: { type: "dashed", color: "rgba(133, 141, 152, 0.1)" },
		},
	},
	yAxis: {
		axisLine: { lineStyle: { color: "#858d98" } },
			...
			itemStyle: {
				normal: {
					...
					color: new echarts.graphic.RadialGradient(0.4, 0.3, 1, [
						{ offset: 0, color: bubbleColors[1] },
						{ offset: 1, color: bubbleColors[0] },
					]),
				},
			},
		},
		{
			...
			itemStyle: {
				normal: {
					...
					shadowOffsetY: 5,
					color: new echarts.graphic.RadialGradient(0.4, 0.3, 1, [
						{ offset: 0, color: bubbleColors[4] },
						{ offset: 1, color: bubbleColors[3] },
					]),
				},
			},
		},
